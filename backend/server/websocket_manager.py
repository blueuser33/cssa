...
from report_type import AcademicSurveyReport, BasicReport, DetailedReport
...
async def run_agent(
    ...
    elif report_type == ReportType.AcademicSurvey.value:
        researcher = AcademicSurveyReport(
            query=task,
            tone=tone,
            config_path=config_path,
