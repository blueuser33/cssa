...
def extract_command_data(json_data: Dict) -> tuple:
    return (
        ...
        json_data.get("academic_sources"),
        json_data.get("year_from"),
        json_data.get("year_to"),
        json_data.get("max_papers"),
        json_data.get("language"),
        json_data.get("enable_citation_audit", True),
    )
